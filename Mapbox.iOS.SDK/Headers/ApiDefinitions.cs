...
namespace MapboxBindings
{
	...
	[Protocol, Model]
	interface MGLCluster //: IMGLFeature
	{
	...
	interface MGLMapViewDelegate
	{
		...
		bool ShouldChangeFromCameraWithReason(MGLMapView mapView, MGLMapCamera oldCamera, MGLMapCamera newCamera, MGLCameraChangeReason reason);
		...
		void RegionWillChange(MGLMapView mapView, bool animated);
		...
		void RegionDidChange(MGLMapView mapView, bool animated);
